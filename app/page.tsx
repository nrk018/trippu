      ...
      <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 animate-slide-up animation-delay-300">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Card className="border-3 border-yellow-300 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up animation-delay-600 hover:scale-105 transform rotate-1 hover:rotate-0">
              <CardContent className="p-6 text-center bg-yellow-50">
                <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-4 transform -rotate-3">
                  <Bike className="w-8 h-8 text-gray-800" />
                </div>
                <h3 className="font-black text-gray-800 mb-2 text-lg">Rent & Ride</h3>
                <p className="text-gray-700 font-medium">Bikes, scooters delivered to your hostel door!</p>
              </CardContent>
            </Card>

            <Card className="border-3 border-orange-300 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up animation-delay-800 hover:scale-105 transform -rotate-1 hover:rotate-0">
              <CardContent className="p-6 text-center bg-orange-50">
                <div className="w-16 h-16 bg-orange-400 rounded-2xl flex items-center justify-center mx-auto mb-4 transform rotate-3">
                  <Car className="w-8 h-8 text-white" />
                </div>
                <h3 className="font-black text-gray-800 mb-2 text-lg">Daily Cabs</h3>
                <p className="text-gray-700 font-medium">Subscribe to daily rides, never miss class!</p>
              </CardContent>
            </Card>

            <Card className="border-3 border-yellow-300 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up animation-delay-1000 hover:scale-105 transform rotate-1 hover:rotate-0">
              <CardContent className="p-6 text-center bg-yellow-50">
                <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-4 transform -rotate-2">
                  <Users className="w-8 h-8 text-gray-800" />
                </div>
                <h3 className="font-black text-gray-800 mb-2 text-lg">Squad Trips</h3>
                <p className="text-gray-700 font-medium">Group bookings for epic adventures!</p>
              </CardContent>
            </Card>
          </div>
        </div>
            ...
            <CardContent className="p-8">
              ...
              {!isSubscribed ? (
                <form onSubmit={handleSubscribe} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-black text-lg py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    Count Me In! 🚀
                  </Button>
                </form>
